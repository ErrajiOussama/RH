...
urlpatterns = [
  ...
  path('EditSA/<int:id>',views.EditS_Admin_View,name="EditSA"),
  path('EditSC/<int:id>',views.EditS_Canada_View,name="EditSC"),
  ...
  path('Modif Salaire Agent Admin/',views.TableView_Paie_Mod_Admin ,name="ModifSA"),
