...
class Collaborateur(models.Model):
    ...
    Nbre_d_heures_Travaillees= models.FloatField(default=0,null=True,blank=True)
...
class MonthYearField(models.CharField):
    def __init__(self, *args, **kwargs):
        kwargs['max_length'] = 20  # Maximum length for 'Month Year' string
        super().__init__(*args, **kwargs)

class Salaire_CANADA(models.Model):
